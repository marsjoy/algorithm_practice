"""
SEE: https://www.hackerrank.com/challenges/ide-identifying-comments/problem
...
for line in sys.stdin.readlines():
    if other in line:
        print(other + line[line.index(other)+2:].rstrip())
    if incomments:
        if ending in line:
            incomments = False 
        print(line.strip())
    if starting in line:
        print(starting + line[line.index(starting)+2:].rstrip())
